...
%
\author{Israel Blancas \inst{1}, J. J. Merelo \inst{1} \and Antonio Álvarez \inst{1}}
%
...
% voluntaria en algoritmos evolutivos,
% ¿En serio? Simplemente lo que
...
% en el título he usado marco, quizás en un congreso español
...
usuarios que decidan colaborar, de la potencia de sus máquinas
y de la capacidad del servidor para repartir el trabajo
...
% Esto lo pongo arriba mejor - Antonio

% Y con esto? Quitarlo le resta importancia, ponerlo parece que
% es la única solución al presupuesto - Antonio
