...
computación voluntaria en cuanto a rendimiento. % ¿Por qué? ¿Qué
                                % quieres medir? ¿En qué completa esto
                                % el resto de los experimentos? 
...
se ha utilizado el de resolver la función ``trap'', con unos valores
de: % Esto pásalo a una tabla
 número de traps, 24;
