...
\title{Marco de aplicaciones para computación evolutiva voluntaria}
...
Para la creación de un nuevo experimento necesitaremos modificar, al menos, dos ficheros: ``is\_solution.js'' 
-que se ejecuta en el servidor, decide si el cromosoma enviado por el cliente es una solución aceptable- y 
...
Mediante los experimentos que se realizaron en \cite{nodio}, el lector puede comprobar que 
Javascript es un lenguaje suficientemente rápido como para realizar este tipo de experimentos.
