...
NodIO \cite{nodio} es un marco de desarrollo de aplicaciones para la creación de este
tipo de experimentos. A diferencia de otros frameworks que realizan las mismas
tareas, NodIO no necesita instalar ninguna aplicación ni bibliteca en
...
introducirá a NodIO, un framework de desarrollo de experimentos
de computación evolutiva en nube, que frente a los frameworks actuales,
...
del software), hacen que el método no sea ideal.
...
NodIO funciona según un paradigma cliente - servidor:
\begin{itemize}
  \item Servidor: realiza la coordinación de los clientes, almacena los distintos cromosomas y
  el estado de los experimentos y reinicia el experimento cuando se ha encontrado la solución.
  El acceso y envío de los distintos cromosomas se hace a través de una interfaz API/REST.
