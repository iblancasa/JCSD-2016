...
% ¿Qué estás haciendo en este trabajo? ¿Con qué objetivo? ¿Haces
% experimentos? ¿Porqué los haces? Tienes que ponerlo también en el
% resumen. - JJ
\end{abstract}
...
la única opción viable es recurrir a la computación voluntaria. % Y la
                                % computación voluntaria es... - JJ

% Y nos interesa la computación evolutiva porque... - JJ
En este artículo se desean demostrar las bondades de la computación
voluntaria en algoritmos evolutivos, % ¿En serio? Simplemente lo que
                                % tratas es de presentar un marco para
                                % trabajar con ella en computación
                                % evolutiva - JJ
...
de computación evolutiva en nube, que frente a los \textit{frameworks}
actuales, % en el título he usado marco, quizás en un congreso español
          % sea más correcto que framework. - JJ
no precisa de instalación de ningún software por parte del usuario voluntario, salvo un navegador
web.

%Estás definiendo la computación evolutiva después de
%introducirla. Primero define, luego usa. Y no me gustan los guiones,
%rara vez se usan en un paper - JJ
...
% ¿Ahora? ¿En serio? Una intro es un argumento que tienes que exponer,
% no una serie de slides de powerpoint sin relación o ir definiendo
% las cosas según te acuerdas - JJ
...
En estos sistemas se desean características como %según dijo... JJ
 tolerancia a fallos -en caso que una o varias de las
máquinas deje de hacer un trabajo, es conveniente que ese cómputo sea
realizado por otro usuario y la pérdida  
...
y recoger los resultados. %estos párrafos parecen traducidos... - JJ
...
dedicado. % Si el servidor está en un PaaS, es gratis. 
...
los algoritmos se basa en un \textit{framework} llamado \texttt{NodEO} \cite{nodeo},
...
sistema operativo \texttt{GNU/Linux} (distribución \texttt{ArchLinux} con \texttt{kernel} 4.5.1) con un procesador \texttt{i5-2410M CPU @ 
  2.30GHz}. El navegador utilizado ha sido la versión 50 de \texttt{Chromium}.
