...
\title{NodIO: Marco de desarrollo aplicaciones para computación evolutiva voluntaria}
...
gratuíta como pueden ser muchos ``Plataforma como servicio'', el coste es menor aún.
...
En cuanto a \textit{marcos de desarrollo} orientados a computación voluntaria con algoritmos evolutivos, ya en \cite{cole2010evolutionary}
...
los algoritmos se basa en un \textit{marco de desarrollo} llamado \texttt{NodEO} \cite{nodeo},
